...
1. Moderated multiple regression (MMR) model
\begin{equation}
...
2. Heteroskedasticity: practical contribution
...
3. Endogeneity: practical contribution
  
  One of the common cause = important variable is missing.
