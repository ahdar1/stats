...
[Click this link: https://lancasteruni.eu.qualtrics.com/jfe/form/SV_4M9c69OeyGzsTb0](https://lancasteruni.eu.qualtrics.com/jfe/form/SV_4M9c69OeyGzsTb0)

# Quiz

Imagine that you are on a game show. The show host presents you with a choice of three doors: Behind one door is a **car** and behind the other doors are goats. Of course, you want the car -- if you win, you can keep it.
...
```{r message=FALSE, warning=FALSE, fig.align='center' ,out.height="30%", out.width="30%", fig.cap="Art: Hilda Bastian"}
knitr::include_graphics("img/doors_monthy.png")
```

---
## The important of statistical thinking
...
## **Apply** knowledge into a new setting
  ...
  * Seems easy to do but positioning contribution beyond mere application is challenging
   ...
   + Repetition can be boring 
    ...
    + Aplikasi theori ABC: studi kasus pemasaran di perusahaan X. 
 ...
 * Try to publish
 * Leave your footprint: move to another domain after publishing 2-3 articles
...
dat <- as_data_frame(cbind(x,z, y))
write_sav(dat,"/Users/ahmaddaryanto/Documents/Temp/demo.sav")
```
---
...
* Publish in a journal
  - benefit of submission: getting a feedback
