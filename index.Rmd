...
* Moderated multiple regression (MMR) model
\begin{equation}
...
---
# Spurious - demo
Putting our demo into a [contex](https://www.sciencedirect.com/science/article/abs/pii/S0148296319304606)
...
```{r, echo= TRUE, warning=FALSE, message=FALSE}
 xz <- x * z  # create an interaction term
 fit <- lm(y ~ x + z + x:z)
 res <- summary(fit)
 print(res)
